  ...
  <div className="col">
    ...
    <span className="p-2 rounded icon-about"><i class="fs-5 bi bi-clock text-white"></i></span>
      <div className="card-body mt-3">
        ...
        <p className="card-text">El proyecto fue desarrollado en tan sólo 3 semanas, durante marzo de 2023. El mismo se dividió en demos de una semana de duración.</p>
      </div>
    </div>
  </div>
  <div className="col">
...
<div class="row g-2">
  <div class="col-md-6  col-lg-3">
    <div class="card border-0 p-3">
      <img src="/img/team_Andres.png" class="img-team-ali shadow mx-auto" alt="..."/>
  ...
  <div class="col-md-6 col-lg-3">
    <div class="card border-0 p-3">
      <img src="/img/VirginiaBarbaroimg.jpg" class="img-team-ali shadow mx-auto" alt="..."/>
      <div class="card-body text-center">
  ...
  <div class="col-md-6 col-lg-3">
    <div class="card border-0 p-3">
      <img src="/img/AlineFariasprueba.jpg" class="img-team-ali shadow mx-auto" alt="..."/>
      <div class="card-body text-center">
  ...
  <div class="col-md-6 col-lg-3">
    <div class="card border-0 p-3">
      <img src="/img/Mathi.jpg" class="img-team-ali shadow mx-auto" alt="..."/>
      <div class="card-body text-center">
